...
<body>
	...
	<div id="back" style="height: 600px;">
		<!-- btn Set -->
		<div class="btnSelect" id="btnArea" style='padding: 15px;'>

			<a onclick='resetModal();' href="#updateForm" role="button"
				class="btn-social pull-right" data-toggle="modal"> <i
				class="icon-edit icon-white"></i> <strong>수 정 &nbsp &nbsp
					&nbsp</strong></a> <a href="#testForm" role="button"
				class="btn-social pull-right" data-toggle="modal"> <i
				class="icon-trash icon-white"></i> <strong>삭 제 &nbsp &nbsp
					&nbsp</strong></a> <a href="/book/regphoto" role="button"
				class="btn-social pull-right"> <i class="icon-camera icon-white"></i><strong>
					사진 등록 &nbsp &nbsp &nbsp </strong></a> <a href="/book/regist" role="button"
				class="btn-social pull-right"> <i class="icon-book icon-white"></i><strong>
					도감 등록 &nbsp &nbsp &nbsp </strong>
			</a>
		...
		<div class="sample span12" style="height: 10px; padding: 5px;">
			...
			<!-- 모달 -->
			<div class="modal fade" id="testForm" tabindex="-1" role="dialog"
				...
				<div class="modal-body">
					<label> 도감을 선택해주세요. </label> <select id="delBook"
						class="form-control" name="bno" style="width: 250px; opacity: 0.9"></select>
				</div>
				<div class="modal-footer" id="delmodal">
					<button class="btn" data-dismiss="modal" aria-hidden="true"
						style='font-family: Nanum Gothic, serif;'>닫기</button>
			...
			<div class="modal fade" id="updateForm" tabindex="-1" role="dialog"
				...
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">×</button>
					<h3 id="mTitle"
						style="text-align: center; font-family: Nanum Gothic, serif;">
						<!-- 제목 들어가는 부분 -->
					</h3>
				</div>

				<div class="modal-body text-center">
					<label> 도감을 선택해주세요. </label> <select id="UpdateBook"
						class="form-control" name="bno" style="width: 250px; opacity: 0.9"
						onchange="showlist(this.value)"></select>
					<div id="mContfile" style="width: 100%;"></div>
				</div>
