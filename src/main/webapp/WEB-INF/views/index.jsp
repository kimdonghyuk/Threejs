                ...
                <div id="myCarousel" class="carousel slide clients">
                  ...
                  <div class="carousel-inner">
                    <div class="active item">
                        <div class="row-fluid">
                            <ul class="thumbnails">
                                <li class="span3"><a href="#"><img src="resources/images/sample/clients/client1.png"></a></li>
                                <li class="span3"><a href="#"><img src="resources/images/sample/clients/client2.png"></a></li>
                                <li class="span3"><a href="#"><img src="resources/images/sample/clients/client3.png"></a></li>
                                <li class="span3"><a href="#"><img src="resources/images/sample/clients/client4.png"></a></li>
                            </ul>
                        </div>
                    </div>
