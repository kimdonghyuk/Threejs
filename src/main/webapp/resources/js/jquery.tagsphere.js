...
(function($){
    ...
    $.fn.tagcloud.defaults = {
        ...
        centrex: 100, // set centre of display , <div>에 넣은 스타일 크기값의 절반으로 정해줘야 밖으로 값들이 밖으로 벗어나지 않는다.
        centrey: 100,
...
*/
        ...
        //음영 넣는 부분
        // dis_percent를 100으로 놓으면 구를 굴려도 음영이 변하지않는다.
        ...
        function draw(){
            ...
            if(dirty){
                ...
                for(var s_p in points_data){
                    ...
                    points_data[s_p].element.css('opacity', op);
                    points_data[s_p].element.children().css('width', area+"%");
                    points_data[s_p].element.css('margin', "auto");
